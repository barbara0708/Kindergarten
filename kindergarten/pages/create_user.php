        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Create New User</h3>
              <form method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="userType" id="admin" value="1" checked />
                      <label class="form-check-label" for="admin">Admin</label>
                    </div>

                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="userType" id="parent" value="2" />
                      <label class="form-check-label" for="parent">Teacher</label>
                    </div>

                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="userType" id="teacher" value="3" />
                      <label class="form-check-label" for="teacher">Parent</label>
                    </div>
                ...
                <div class="mt-2">
                  <input class="btn btn-primary btn-lg" name="create" type="submit" value="Submit" />
                </div>
